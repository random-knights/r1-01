...
## <span style="color:#FAAFA5"><u> **R10-01** </u></span>
...
### <span style="color:#8855ff"><u> **THE ORACLES** </u></span>
...
| Side button      | Reveal / next quote | ⏭️ |
| Tap the orb      | Reveal a quote      | 🔄 |
| Scroll wheel / swipe | Change oracle   | ↔️ |
...
<small>Hardware shake/scroll/side&#8209;button fire only on the R1 device.</small>
...
| ----------- | :--------: | :------: | :---------------------------------: |
| Earth+      |     🌎     |  v1.0.0  |        Earth Health Scoring         |
| AiEDs       |     ⚡     |  v2.0.0  |        AI Energy Disclosure         |
| K13         |     👑     |  v1.5.0  |        AI Summary Reporting         |
